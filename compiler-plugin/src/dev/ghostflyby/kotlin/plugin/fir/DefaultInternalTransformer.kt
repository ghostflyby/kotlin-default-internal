...
class DefaultInternalTransformer(
    session: FirSession,
    ...
    override fun transformStatus(
        ...
        return if (property.source?.kind == KtFakeSourceElementKind.PropertyFromParameter &&
            containingClass?.visibility == Visibilities.Public
        ) {
            status
        } else {
